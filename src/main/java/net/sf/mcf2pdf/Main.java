...
public class Main {
	...
	public static void main(String[] args) {
		...
		options.addOption("l", false, "Render Text as image instead of creating text fields.");
        ...
        boolean renderText = cl.hasOption("l");
		...
		try {
			new Mcf2FoConverter(installDir, tempDir, tempImages).convert(
					mcfFile, xslFoOut, dpi, binding, maxPageNo, renderText);
			xslFoOut.flush();
